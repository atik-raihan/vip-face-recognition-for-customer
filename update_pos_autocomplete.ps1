        ...
        <div class="box box-info">
          ...
          <div class="box-body">
            <form id="sale-form" method="post" action="{% url 'pos' %}">
              ...
              <input type="hidden" name="customer" id="customer-id-input" value="">

              <!-- Search with Autocomplete -->
              <div class="form-group" id="customer-search-wrap" style="position:relative;">
                <label>Search Customer</label>
                <div class="input-group">
                  <input type="text" id="customer-search" class="form-control" placeholder="Type phone or name..." autocomplete="off">
                  <span class="input-group-btn">
                    <button type="button" class="btn btn-success" onclick="openAddCustomerModal()" title="Add New Customer">
                ...
                <!-- Dropdown Results -->
                <div id="customer-dropdown" style="display:none; position:absolute; width:100%; background:#fff; border:1px solid #ddd; border-top:none; border-radius:0 0 4px 4px; max-height:220px; overflow-y:auto; z-index:999; box-shadow:0 6px 12px rgba(0,0,0,0.175);"></div>

                <!-- Selected Customer Display -->
                <div id="selected-customer" style="display:none; margin-top:8px; padding:8px 12px; background:#d4edda; border:1px solid #c3e6cb; border-radius:4px; color:#155724;">
                  <i class="fa fa-check-circle"></i> <span id="selected-customer-text"></span>
                  <a href="javascript:void(0)" onclick="clearCustomer()" style="float:right; color:#155724; text-decoration:none;"><i class="fa fa-times"></i></a>
                </div>
              </div>
...
var allCustomers = [
  {% for customer in customers %}
  {
    ...
    is_vip: {% if customer.is_vip %}true{% else %}false{% endif %}
