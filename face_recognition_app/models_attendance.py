...
class Employee(models.Model):
    ...
    # String reference avoids needing an import, matching the same pattern
    # already used below for Camera - sidesteps any import-order issue.
    branch = models.ForeignKey(
        "face_recognition_app.Branch", null=True, blank=True, on_delete=models.SET_NULL,
